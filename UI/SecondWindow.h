...
QT_BEGIN_NAMESPACE
namespace Ui { class second_ui; }
QT_END_NAMESPACE

class SecondWindow : public QMainWindow { //, public Ui_second_ui {
//class SecondWindow : QMainWindow {
    Q_OBJECT
public:
    SecondWindow(std::shared_ptr<Connector> connector = nullptr);
